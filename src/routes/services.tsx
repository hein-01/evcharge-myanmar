...
export default function ServicesPage() {
  useEffect(() => { document.title = "EV Workshops & Insurance — EVCharge Myanmar"; }, []);
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-28">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">Verified EV repair shops, insurance providers and financing partners across Myanmar.</p>
                ...
                <div key={w.name} className="group overflow-hidden rounded-2xl border border-border bg-card transition hover:border-electric/40" style={{ boxShadow: "var(--shadow-card)" }}>
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2">
                      ...
                      <a href={`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(`${w.name}, ${w.city}, Myanmar`)}`} target="_blank" rel="noopener noreferrer"
          ...
          <section className="mt-16 pb-20">
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Compare plans from Myanmar's leading providers</p>
              </div>
            </div>
