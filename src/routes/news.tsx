    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pt-28">
        <div className="mx-auto max-w-7xl px-6">
          ...
          {feature && (
            <article className="mt-10 grid gap-8 overflow-hidden rounded-3xl border border-border bg-card md:grid-cols-2" style={{ boxShadow: "var(--shadow-card)" }}>
              <div
          ...
          <div className="mt-12 grid gap-6 pb-20 md:grid-cols-2 lg:grid-cols-3">
            {rest.map((a) => (
              <article key={a.id} className="group overflow-hidden rounded-2xl border border-border bg-card transition hover:border-electric/40" style={{ boxShadow: "var(--shadow-card)" }}>
                <div
